class AndroidsController < ApplicationController
  ...
  def sold
      ...
      @android.no_of_stock = @android.no_of_stock-1;
      @android.save
  ...
  private
    ...
    def android_params
      params.require(:android).permit(:name, :brand, :year_released, :camera, :mpixel, :internal_memory, :no_of_sim_slots, :size_of_screen, :no_of_stock)
    end
end
